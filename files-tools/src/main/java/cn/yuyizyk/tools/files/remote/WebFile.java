...
public class WebFile {
	...
	public FileType getType() {
		...
		if (Images.isImageExtension(extension)) {
			return FileType.image;
				...
				|| "js".equalsIgnoreCase(extension) || "css".equalsIgnoreCase(extension)
				|| "txt".equalsIgnoreCase(extension) || "xml".equalsIgnoreCase(extension)
				|| "ftl".equalsIgnoreCase(extension) || "vm".equalsIgnoreCase(extension)
				|| "jsp".equalsIgnoreCase(extension) || "jspx".equalsIgnoreCase(extension)
				|| "asp".equalsIgnoreCase(extension) || "aspx".equalsIgnoreCase(extension)
				|| "php".equalsIgnoreCase(extension) || "sql".equalsIgnoreCase(extension)
				|| "tag".equalsIgnoreCase(extension) || "tld".equalsIgnoreCase(extension)
	...
	public static class HiddenFilter implements FileFilter {
		...
		public boolean accept(File pathname) {
			if (StringUtils.isNotBlank(search)) {
				...
				return !pathname.isHidden() && StringUtils.containsIgnoreCase(name, search);
			} else {
	...
	public static void sort(List<WebFile> list, String sort, String directionection) {
		...
		if ("name".equals(sort)) {
			...
			comp = "desc".equals(directionection) ? LASTMODIFIED_DESC : LASTMODIFIED_ASC;
