 ...
 */
public class Regex {
	public final static Logger log = LoggerFactory.getLogger(Regex.class);
	...
	public static final boolean matches(String str, String regex) {
		return !Strs.isBank(str) && str.matches(regex);
	}
	...
	public static void main(String[] args) {
		System.err.println(Mobile("18208121484"));
	}
