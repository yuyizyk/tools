...
public abstract class Reflections {
	...
	public static boolean contains(Collection<?> coll, Object value, String field) {
	...
	public static boolean containsAny(Collection<?> coll1, Collection<?> coll2, String field) {
		if (CollectionUtils.isEmpty(coll1) || CollectionUtils.isEmpty(coll2) || StringUtils.isBlank(field)) {
			return false;
		}
	...
	public static Object getPerperty(Object obj, String field) {
		...
		try {
			descriptor = propertyUtilsBean.getPropertyDescriptor(obj, field);
